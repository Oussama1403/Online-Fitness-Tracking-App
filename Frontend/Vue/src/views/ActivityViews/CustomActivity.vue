  ...
  <div class="container custom-container mt-4">
    <Form @submit="saveActivity" v-slot="{ errors }">
      ...
      <div class="fade-in">
        ...
        <div v-for="(labelField, index) in fields" :key="index" class="group mb-3">
          <div class="form-group">
            <Field
              ...
              class="input form-control label"
              :id="'labelName' + index"
              v-model="labelField.name"
        ...
        <button type="button" class="add-button btn btn-primary mb-3" @click="addLabelField">
          Add New Label
        </button>
