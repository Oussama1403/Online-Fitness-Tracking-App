  ...
  <div class="activities">
    <div class="container-fluid px-4">
      ...
      <h5 class="mb-4 mt-4 text-center intro-text fade-in">
        Track your progress by logging the activities
        <span class="intro-important"> you've completed.</span>
      </h5>
      <div class="row">
        <div class="col-xl-3 col-md-6 mb-4" v-for="activity in activities" :key="activity.name">
          <div class="card text-center bg-light text-dark h-100 fade-in">
            ...
            <div class="card-body">
              ...
              <router-link
                :to="{ name: 'LogActivity', params: { activityName: activity.name } }"
        ...
        <div class="col-xl-3 col-md-6 mb-4">
          <div class="card text-center bg-light text-dark h-100 fade-in">
            ...
            <div class="card-body">
              ...
              <router-link
                :to="{ name: 'CustomActivity', params: { activityName: custom_activity } }"
                class="btn btn-primary mt-3"
              >
                Log Activity
              </router-link>
...
export default {
  ...
  data() {
    return {
      activities: [
        { name: 'Running', image: 'src/assets/images/running.png' },
        { name: 'Cycling', image: 'src/assets/images/cycling.png' },
